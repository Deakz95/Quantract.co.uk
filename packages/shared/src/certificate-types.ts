...
export const fireAlarmCertificateSchema = z.object({
  ...
  testResults: z.object({
    panelFunctional: z.union([z.boolean(), z.string()]).optional().default(""),
    soundersAudible: z.union([z.boolean(), z.string()]).optional().default(""),
    remoteSoundersAudible: z.union([z.boolean(), z.string()]).optional().default(""),
    batteryVoltage: z.string().optional().default(""),
    batteryCondition: z.enum(["good", "fair", "replace", ""]).optional().default(""),
    allDevicesTested: z.union([z.boolean(), z.string()]).optional().default(""),
    faultIndicatorsTested: z.union([z.boolean(), z.string()]).optional().default(""),
    zonesLabelled: z.union([z.boolean(), z.string()]).optional().default(""),
    logBookAvailable: z.union([z.boolean(), z.string()]).optional().default(""),
  }).optional().default({}),
...
export const emergencyLightingCertificateSchema = z.object({
  ...
  testResults: z.object({
    ...
    allLuminairesFunctional: z.union([z.boolean(), z.string()]).optional().default(""),
    exitSignsVisible: z.union([z.boolean(), z.string()]).optional().default(""),
    illuminationAdequate: z.union([z.boolean(), z.string()]).optional().default(""),
    logBookAvailable: z.union([z.boolean(), z.string()]).optional().default(""),
  }).optional().default({}),
  observations: z.array(z.object({
    code: z.string().optional().default(""),
