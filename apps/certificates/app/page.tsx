    ...
    <main className="min-h-screen bg-[var(--background)] text-[var(--foreground)]">
      ...
      <div className="relative z-[1] py-12 px-6 max-w-[1200px] mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <Link
            href="/dashboard"
            className="inline-flex items-center gap-2 mt-4 text-sm text-[var(--primary)] hover:text-[var(--primary-dark)] font-medium transition-colors"
          >
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
            </svg>
            View My Saved Certificates
          </Link>
        </div>
