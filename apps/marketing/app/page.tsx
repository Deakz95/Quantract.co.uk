  ...
  return (
    <>
      ...
      <main id="main-content">
        ...
        {/* RAMS & Safety Callout */}
        <section className="rams-callout">
          <div className="container">
            <div className="rams-callout-grid">
              <div className="rams-callout-content">
                <div className="rams-callout-badge">
                  <HardHat size={14} />
                  <span>Compliance</span>
                </div>
                <h2>RAMS &amp; Safety Assessments</h2>
                <p className="rams-callout-value">
                  Generate professional RAMS &amp; Safety Assessments in minutes.
                </p>
                <ul className="rams-callout-bullets">
                  <li>
                    <ClipboardCheck size={18} className="rams-bullet-icon" />
                    <span>Built for electricians and contractors</span>
                  </li>
                  <li>
                    <ClipboardCheck size={18} className="rams-bullet-icon" />
                    <span>Draft, issue, and download compliant PDFs</span>
                  </li>
                  <li>
                    <ClipboardCheck size={18} className="rams-bullet-icon" />
                    <span>Clear DRAFT vs ISSUED documents</span>
                  </li>
                  <li>
                    <ClipboardCheck size={18} className="rams-bullet-icon" />
              ...
              <div className="rams-callout-visual">
                <div className="rams-pdf-frame">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img
                    src="/rams-pdf-preview.svg"
                    alt="Example RAMS document generated by Quantract showing hazard assessment, method statement, and PPE requirements"
                    width={420}
                    height={595}
                    loading="lazy"
                  />
