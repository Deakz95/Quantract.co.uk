        ...
        {mode === "quote" ? (
            ...
            <CardContent>
              <div className="grid gap-3">
                <label className="grid gap-1">
                  <span className="text-xs font-semibold text-slate-700">Select quote</span>
                  <select
          ...
          <Card>
            ...
            <CardContent>
              <div className="grid gap-3">
                <label className="grid gap-1">
                  <span className="text-xs font-semibold text-slate-700">Select existing client (optional)</span>
                  <select
                    className="h-11 rounded-2xl border border-slate-200 bg-white px-4 text-sm"
                ...
                <label className="grid gap-1">
                  <span className="text-xs font-semibold text-slate-700">VAT</span>
                  <input
                    type="number"
                    min={0}
                    step="0.01"
                ...
                <div className="text-sm font-semibold text-slate-700">Total: £{total || "0.00"}</div>
        ...
        <Card>
          ...
          <CardContent>
            <ul className="space-y-2 text-sm text-slate-700">
              <li className="rounded-2xl border border-slate-200 bg-white p-3">Review and send the invoice to your client.</li>
              <li className="rounded-2xl border border-slate-200 bg-white p-3">Track payment status and send reminders.</li>
              <li className="rounded-2xl border border-slate-200 bg-white p-3">Mark as paid when payment is received.</li>
            </ul>
          </CardContent>
        </Card>
      </div>
