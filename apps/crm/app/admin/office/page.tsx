...
export default function OfficeControlRoomPage() {
  ...
  return (
    <AppShell role="admin" title="Office Control Room" subtitle="Daily operations at a glance">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <Card className="col-span-1">
                <CardContent className="p-5">
                  ...
                  <Link href="/admin/schedule" className="text-xs font-medium text-[var(--primary)] hover:underline inline-flex items-center gap-1">
              ...
              <Card className="col-span-1">
                <CardContent className="p-5">
                  ...
                  <Link href="/admin/office/approvals" className="text-xs font-medium text-[var(--primary)] hover:underline inline-flex items-center gap-1">
              ...
              <Card className="col-span-1">
                <CardContent className="p-5">
                  ...
                  <Link href="/admin/office/alerts" className="text-xs font-medium text-[var(--primary)] hover:underline inline-flex items-center gap-1">
              ...
              <Card className="col-span-1">
                <CardContent className="p-5">
                  ...
                  <Link href="/admin/office/compliance" className="text-xs font-medium text-[var(--primary)] hover:underline inline-flex items-center gap-1">
                      ...
                      {data.profitLeakage.overdueInvoices.length > 0 ? (
                        <div className="space-y-1.5">
                          {data.profitLeakage.overdueInvoices.slice(0, 4).map((inv) => (
                            <Link key={inv.id} href={`/admin/invoices/${inv.id}`} className="flex items-center justify-between text-xs hover:bg-[var(--muted)] rounded px-1 py-0.5 -mx-1">
                      ...
                      {data.profitLeakage.unbilledJobs.length > 0 ? (
                        <div className="space-y-1.5">
                          {data.profitLeakage.unbilledJobs.slice(0, 4).map((job) => (
                            <Link key={job.id} href={`/admin/jobs/${job.id}`} className="flex items-center justify-between text-xs hover:bg-[var(--muted)] rounded px-1 py-0.5 -mx-1">
