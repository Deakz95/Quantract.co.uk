...
export default function ComplianceDashboardPage() {
  ...
  return (
    <AppShell role="admin" title="Compliance" subtitle="Asset checks, certificate observations, and due items">
            ...
            <Card>
              <CardHeader>
                <div className="flex items-center justify-between">
                  ...
                  <Link href="/admin/scheduled-checks" className="text-xs font-medium text-[var(--primary)] hover:underline inline-flex items-center gap-1">
