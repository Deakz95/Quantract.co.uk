...
export default function ApprovalsInboxPage() {
  ...
  return (
    <AppShell role="admin" title="Approvals Inbox" subtitle="Review and approve timesheets and expenses">
              ...
              <div className="divide-y divide-[var(--border)]">
                {items.map((item) => (
                  ...
                  >
                    ...
                    <Link
                      href={item.type === "timesheet" ? `/admin/timesheets/${item.id}` : `/admin/expenses`}
