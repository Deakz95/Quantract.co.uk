...
import { Receipt, RefreshCcw, AlertTriangle, CheckCircle } from "lucide-react";
...
export default function OfficePurchasingPage() {
  ...
  return (
    <AppShell role="office" title="Purchasing" subtitle="Supplier invoices and bills">
