  ...
  useEffect(() => {
    ...
    const handleMove = (e: MouseEvent) => {
      ...
      if (resizing) {
        ...
        updateElement(resizing.id, { w: newW, h: newH });
      }
    };
                      ...
                      <div className="mt-1 flex flex-wrap gap-1">
                        {bindings.slice(0, 8).map(b => (
                          <button
                            ...
                            className="px-1.5 py-0.5 rounded bg-blue-50 text-blue-700 text-[10px] hover:bg-blue-100 dark:bg-blue-950 dark:text-blue-300"
                          >
                            {b}
                          </button>
                        ))}
