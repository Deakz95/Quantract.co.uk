...
const STATUS_MAP: Record<string, { label: string; bg: string; fg: string }> = {
  ...
  closed:      { label: "Completed",     bg: "rgba(22,163,74,0.08)",  fg: "#15803d" },
  paid:        { label: "Paid",          bg: "rgba(22,163,74,0.08)",  fg: "#15803d" },
  issued:      { label: "Issued",        bg: "rgba(22,163,74,0.08)",  fg: "#15803d" },
  accepted:    { label: "Accepted",      bg: "rgba(22,163,74,0.08)",  fg: "#15803d" },
  ...
  unpaid:      { label: "Awaiting payment", bg: "rgba(234,88,12,0.08)", fg: "#c2410c" },
};
